...
namespace Hedera.Hashgraph.Reference.Contract
{
    ...
    public interface IStorageChange<TSelf> : IStorageChange where TSelf : IStorageChange<TSelf>
    {
        abstract static TSelf CTOR(BigInteger slot, BigInteger valueRead, BigInteger valueWritten);
        /// <summary>
