namespace Hedera.Hashgraph.Reference.Core
{
    ...
    public interface IClient
    {
        ...
        ///
        /// </summary>
        abstract static IClient ForNetwork(Map < String network, object [`AccountId`](../cryptocurrency/AccountId.md) >)
        ...
        ///
        /// </summary>
        IClient SetOperatorWith(IAccountId accountId, IPublicKey publicKey, (bytes) => bytes transactionSigner)
        ...
        ///
        /// </summary>
        PublicKey? OperatorPublicKey { get; }
