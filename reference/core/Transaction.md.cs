namespace Hedera.Hashgraph.Reference.Core
{
    ...
    public interface ITransaction
    {
        ...
        ///
        /// </summary>
        AccoundId GetTransactionHashPerNode()
        ...
        ///
        /// </summary>
        ScheduleCreateTransaction > Schedule()
        ...
        ///
        /// </summary>
        ITransaction SignWith(IPublicKey publicKey, (bytes) => bytes transactionSigner)
